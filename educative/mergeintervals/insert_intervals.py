...
Time: As we are iterating through all the intervals only once, the time complexity of the above algo is O(N)
Space: The space complexity of the above algo is O(N) as we need to return a list containing all the merged intervals.
"""
...
def main():
    print("Intervals after inserting the new interval: " + str(insert_intervals([[1, 3], [5, 7], [8, 12]], [4, 6])))
