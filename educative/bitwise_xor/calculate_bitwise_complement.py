...
def calculate_bitwise_complement(num):
    ...
    '''
    For a number which is a complete power of '2' i.e., it can be written as pow(2, n), if we subtract '1' from such a 
    number, we get a number which has 'n' least significant bits set to '1'.
    For Example, '4' which is a complete power of '2' and '3' (which is one less than 4) has a binary representation 
