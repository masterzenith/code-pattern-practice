...
3. The node right before the start of sub-list will the new tail of the rotated LinkedList.

Time: O(N) where N is the total number of nodes in the LinkedList.
Space: we only need constant space, therefore, the space complexity of our algo is O(1)
"""
