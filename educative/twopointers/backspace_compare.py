"""
Given two strings containing backspaces (identified by the character '#'), check if thw two strings are equal
I/P: str1="xy#z", str2="xzz#"
O/P: true
Explanation: After applying backspaces the strings become "xz" and "xz" respectively.

I/P: str1="xy#z", str2="xyz#"
O/P: false
Explanation: After applying backspaces the strings become "xz" and "xy" respectively.

Time: The time complexity of the above algorithm will be O(M+N) where 'M' and 'N' are the lengths of the two input
